...
The following are my notes adapted from [https://www.tidymodels.org/](https://www.tidymodels.org/).
...
The [parsnip](https://parsnip.tidymodels.org/) package can work with many model types, engines, and arguments. Check out [https://tidymodels.org/find/parsnip](https://tidymodels.org/find/parsnip) to see what is available.
...
_Create dummy variables for all of the factor or character columns unless they are outcomes._
...
Not too bad! Next test out this workflow without this recipe. You can use `workflows::add_formula(arr_delay ~ .)` instead of `add_recipe()` (remember to remove the identification variables first!), and see whether our recipe improved our model’s ability to predict late arrivals.
